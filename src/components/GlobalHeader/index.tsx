...
import { FaBars, FaTimes, FaUser, FaFacebook, FaTwitter, FaInstagram } from 'react-icons/fa';
    ...
    <header className="fixed top-0 left-0 w-full z-10 backdrop-filter backdrop-blur-lg ">
      <div className="container mx-auto flex items-center justify-between p-4 ">
        ...
        <div className="md:hidden flex items-center">
          <button onClick={toggleMenu} className="text-slate-800 hover:text-slate-500 focus:outline-none">
